...
function pfUI.api.serialize(tbl, comp, name, ignored, spacing)
...
function pfUI.api.compress(input)
...
function pfUI.api.decompress(input)
    -- based on Rochet2's lzw compression
...
function pfUI.api.enc(to_encode)
...
function pfUI.api.dec(to_decode)
    local index_table = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'
